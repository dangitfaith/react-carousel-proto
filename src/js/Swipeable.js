/*
* NOTE: original source https://github.com/dogfessional/react-swipeable
*
* Made some minor changes to work with lodash and temp gulp webapp
*/
...
var Swipeable = React.createClass({displayName: "Swipeable",
  ...
  render: function () {
    return React.createElement('div', _.extend({
